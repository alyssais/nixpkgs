...
let
  sources = {
    ...
    "@types/node-10.9.1" = {
      ...
      version = "10.9.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@types/node/-/node-10.9.1.tgz";
        sha512 = "f+qQR5lLCB8UPhtk8Xm8RQvbR4ycD7MOsdiuAEQCYpz44bBx2g7JL0+iYBcjl9J7d0KT1sX2g0VGNeHfw+GXpg==";
      };
    };
